...
func (tx *Transaction) MarshalJSON() ([]byte, error) {
	...
	case *DynamicFeeTx:
		...
		enc.R = (*hexutil.Big)(itx.R)
		enc.S = (*hexutil.Big)(itx.S)
	case *SmartContractUpdateTx:
		enc.ChainID = (*hexutil.Big)(itx.ChainID)
		enc.AccessList = &itx.AccessList
		enc.ReorgList = &itx.ReorgList
		enc.DataTypes = &itx.DataTypes
		enc.Stakeholders = &itx.Stakeholders
		enc.Nonce = (*hexutil.Uint64)(&itx.Nonce)
...
func (tx *Transaction) UnmarshalJSON(input []byte) error {
	...
	case SmartContractUpdateTxType:
		var itx SmartContractUpdateTx
		inner = &itx
		// Access list is optional for now.
		if dec.AccessList != nil {
			itx.AccessList = *dec.AccessList
		}
		if dec.ReorgList != nil {
			itx.ReorgList = *dec.ReorgList
		}
		if dec.DataTypes != nil {
			itx.DataTypes = *dec.DataTypes
		}
		if dec.Stakeholders != nil {
			itx.Stakeholders = *dec.Stakeholders
		}
		if dec.ChainID == nil {
			return errors.New("missing required field 'chainId' in transaction")
		}
		...
		if dec.ProposalNumber == nil {
			return errors.New("missing required field 'proposalnumber' in transaction")
		}
		itx.ProposalNumber = uint64(*dec.ProposalNumber)
