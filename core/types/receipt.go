...
func (r *Receipt) decodeTyped(b []byte) error {
	...
	switch b[0] {
	case DynamicFeeTxType, AccessListTxType, SmartContractUpdateTxType, ApproveProposalTxType, RejectProposalTxType:
		var data receiptRLP
