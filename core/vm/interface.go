...
type StateDB interface {
	...
	GetProposal(addr common.Address, proposalNumber uint64) types.Proposal
	GetVote(addr, voterAddress common.Address, proposalNumber uint64) types.Vote
	SetState(common.Address, common.Hash, common.Hash)
	DeleteKeysFromStorage(addr common.Address, keys []common.Hash)
	SetProposal(addr common.Address, proposalNumber uint64, value types.Proposal)
	SetVote(addr common.Address, proposalNumber uint64, voterAddress common.Address, value types.Vote)
