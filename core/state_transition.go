...
func (st *StateTransition) TransitionDb() (*ExecutionResult, error) {
	...
	fmt.Println("Length of reorgList:", len(reorgList))
	fmt.Println("Length of dataTypes:", len(dataTypes))
	...
	if contractCreation && !contractUpdation && !approvalVote && !rejectionVote {
